...
from .views import DomesticReportListView , ContractPostView , LoadingPostView , FrieghtPostView , ContractGetView , ContractDropdownView , DomesticContractDetailListView



urlpatterns = [
    path('' , DomesticReportListView.as_view()),
    path('details/' , DomesticContractDetailListView.as_view()),
