...
urlpatterns = [
    ...
    path('dfia-license-lines/<str:id>' , DFIALicenseLinesRetrieveUpdateDeleteView.as_view() , name = 'dfia-license-lines-list-create'),
