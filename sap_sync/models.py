...
class FGProducts(models.Model):
    ...
    u_tax_rate = models.IntegerField(null=True, blank=True)
    deleted = models.CharField(max_length=1, null=True, blank=True)
    u_variety = models.CharField(max_length=125, null=True, blank=True)
    sal_pack_un = models.DecimalField(max_digits=9, decimal_places=6, null=True, blank=True)
    u_brand = models.CharField(max_length=125, null=True, blank=True)
    u_unit = models.CharField(max_length=125, null=True, blank=True)
    u_sub_group = models.CharField(max_length=125, null=True, blank=True)
